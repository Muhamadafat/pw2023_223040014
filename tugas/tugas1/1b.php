...
<body>
    ...
    <p>Aku adalah angka <b><?php echo $nrp ?></b><br>
        Jika aku dikali 5, maka aku sekarang menjadi <b><?php echo $nrp = $nrp * 5; ?></b><br>
        Jika aku dibagi 2, maka aku sekarang menjadi <b><?php echo $nrp = $nrp / 2; ?></b><br>
        Jika aku ditambah 75, maka aku sekarang menjadi <b><?php echo $nrp = $nrp + 75; ?></b><br>
        Jika aku dikurang 20, maka aku sekarang menjadi <b><?php echo $nrp = $nrp - 20; ?></b><br>
    </p>
    <?php
